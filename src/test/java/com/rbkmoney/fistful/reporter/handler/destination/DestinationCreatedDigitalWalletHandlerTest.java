...
public class DestinationCreatedDigitalWalletHandlerTest extends AbstractHandlerConfig {
    ...
    public void destinationCreatedHandlerTest() {
        ...
        Assert.assertNotNull(destinationResult.getDigitalWalletId());
        Assert.assertNotNull(destinationResult.getDigitalWalletProvider());
    }
