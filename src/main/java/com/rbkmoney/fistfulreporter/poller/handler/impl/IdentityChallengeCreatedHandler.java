...
import com.rbkmoney.fistfulreporter.domain.enums.ChallengeStatus;
...
public class IdentityChallengeCreatedHandler implements IdentityEventHandler {
    ...
    private ChallengeChange saveChallenge(Change change, SinkEvent event) throws DaoException {
