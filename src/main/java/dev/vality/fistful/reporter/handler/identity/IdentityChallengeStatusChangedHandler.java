...
import dev.vality.fistful.identity.ChallengeStatus;
...
import dev.vality.fistful.reporter.domain.enums.ChallengeEventType;
...
public class IdentityChallengeStatusChangedHandler implements IdentityEventHandler {
    ...
    private Challenge update(
        ...
        challenge.setChallengeStatus(
                TBaseUtil.unionFieldToEnum(status, dev.vality.fistful.reporter.domain.enums.ChallengeStatus.class));
        if (status.isSetCompleted()) {
            ...
            challenge.setChallengeResolution(
                    TypeUtil.toEnumField(
                            ...
                            dev.vality.fistful.reporter.domain.enums.ChallengeResolution.class));
