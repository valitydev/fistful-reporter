...
import dev.vality.fistful.reporter.service.WithdrawalService;
import dev.vality.fistful.reporter.util.FormatUtils;
import dev.vality.fistful.reporter.util.TimeUtils;
...
public class WithdrawalRegistryTemplateServiceImpl implements TemplateService {
    ...
    public void processReportFileByTemplate(Report report, OutputStream outputStream) throws IOException {
        ...
        try (SXSSFWorkbook wb = new SXSSFWorkbook(100)) {
            ...
            while (withdrawals.size() == WithdrawalService.WITHDRAWAL_LIMIT) {
